...
- `TB` [PASS]: beats season-average and Marcel baselines (model MAE 1.259 vs season-avg 1.287, Marcel 1.293).
- `HR` [PASS]: beats season-average and Marcel baselines (model MAE 0.190 vs season-avg 0.192, Marcel 0.200).
...
**Pitching**
- `p_outs` [PASS]: beats season-average and Marcel baselines (model MAE 2.785 vs season-avg 2.971, Marcel 3.047).
- `p_BF` [PASS]: beats season-average and Marcel baselines (model MAE 2.682 vs season-avg 2.908, Marcel 3.093).
- `p_pitches` [PASS]: beats season-average and Marcel baselines (model MAE 9.284 vs season-avg 9.995, Marcel 10.741).
- `p_K` [PASS]: beats season-average and Marcel baselines (model MAE 1.770 vs season-avg 1.917, Marcel 1.889).
- `p_BB` [PASS]: beats season-average and Marcel baselines (model MAE 1.017 vs season-avg 1.083, Marcel 1.027).
- `p_H` [PASS]: beats season-average and Marcel baselines (model MAE 1.721 vs season-avg 1.841, Marcel 1.765).
...
| H      | 50887 |      0.6752 |   0.7137 |   0.684  |   0.6866 |      1.0318 |   1.4102 |   1.0622 |
| TB     | 50887 |      1.2586 |   1.2813 |   1.2869 |   1.2933 |      2.0106 |   2.6306 |   2.0645 |
| HR     | 50887 |      0.1903 |   0.1942 |   0.1921 |   0.1996 |      0.4847 |   0.8255 |   0.4913 |
| BB     | 50887 |      0.4234 |   0.4407 |   0.4292 |   0.4371 |      0.8009 |   1.1933 |   0.8191 |
| SO     | 50887 |      0.6639 |   0.7    |   0.6782 |   0.675  |      0.9875 |   1.3275 |   1.0205 |
| b1     | 50887 |      0.5877 |   0.6033 |   0.5878 |   0.5973 |      0.9652 |   1.3723 |   0.9835 |
| b2     | 50887 |      0.2628 |   0.2583 |   0.2596 |   0.2657 |      0.5929 |   1.0062 |   0.6003 |
...
| stat      |    n |   model_MAE |   b1_MAE |   b2_MAE |   b3_MAE |   model_dev |   b2_dev |   b3_dev |
|:----------|-----:|------------:|---------:|---------:|---------:|------------:|---------:|---------:|
| p_outs    | 4860 |      2.7851 |   3.0989 |   2.9713 |   3.0466 |      0.9938 |   1.1682 |   1.2238 |
| p_BF      | 4860 |      2.6822 |   3.1753 |   2.908  |   3.0933 |      0.7063 |   0.8828 |   1.016  |
| p_pitches | 4860 |      9.2843 |  11.5232 |   9.9953 |  10.7408 |      2.379  |   2.9536 |   3.4844 |
| p_K       | 4860 |      1.7702 |   1.9791 |   1.9172 |   1.8891 |      1.1425 |   1.506  |   1.2576 |
| p_BB      | 4860 |      1.0175 |   1.0599 |   1.0827 |   1.0274 |      1.1128 |   2.3634 |   1.1254 |
| p_H       | 4860 |      1.7214 |   1.7657 |   1.8415 |   1.7648 |      0.9912 |   1.5274 |   1.0713 |
